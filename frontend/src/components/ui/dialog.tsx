...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-6 -mb-6 flex flex-row gap-2 justify-end rounded-b-xl border-t bg-muted/50 p-4",
        className
      )}
      {...props}
    >
      {children}
      {showCloseButton && (
        <DialogPrimitive.Close render={<Button variant="outline" className="rounded-md" />}>
          Close
        </DialogPrimitive.Close>
      )}
    </div>
